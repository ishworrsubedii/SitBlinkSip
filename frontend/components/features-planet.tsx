        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Your Personal Digital Health Guardian
            </h2>
          </div>
              ...
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_3s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl">
                ...
                <div className="relative">
                  ...
                  <div className="pointer-events-none absolute inset-0" aria-hidden="true">
                    ...
                    <div className="absolute left-1/2 top-[5%] -translate-x-1/2 flex space-x-4">
                      {/* AI Monitoring Status */}
                      <div className="rounded-lg bg-black/30 px-3 py-1.5 backdrop-blur-sm">
                        <div className="flex items-center space-x-2 text-white">
                          <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse"></div>
                          <span className="text-[10px] font-medium">AI MONITORING</span>
                        </div>
                      </div>
                    ...
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 space-y-3">
                      ...
                      <div className="rounded-lg bg-black/30 p-3 backdrop-blur-sm">
                        <div className="flex items-center space-x-3 text-white">
                          ...
                          <div>
                            <div className="text-[10px] font-medium uppercase tracking-wider opacity-75">Blink Rate</div>
                      ...
                      <div className="rounded-lg bg-black/30 p-3 backdrop-blur-sm">
                        <div className="flex items-center space-x-3 text-white">
                          ...
                          <div>
                            <div className="text-[10px] font-medium uppercase tracking-wider opacity-75">Posture</div>
                            <div className="font-mono text-sm text-emerald-400">Good Posture</div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Monitor your eye blinks and posture in real-time, with instant feedback to help you maintain healthy work habits.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                All processing happens on your device using your webcam, ensuring your data stays private and secure.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
