  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('/api/waitlist', {
        ...
        body: JSON.stringify({ email, fullName, profession }),
      });
    ...
    <>
      ...
      <main className="relative min-h-screen overflow-x-hidden">
        ...
        <div className="relative min-h-screen flex flex-col">
          <div className="flex-grow mx-auto max-w-6xl px-4 sm:px-6 py-32 md:py-40">
            ...
            <Badge 
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-1">
                ...
                Transform your work health with intelligent monitoring and real-time guidance.
              </p>              
              <div className="grid grid-cols-1 sm:grid-cols-3">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-gray-200/20 hover:border-gray-300/30 transition-colors shadow-sm">
                  <span className="block font-semibold text-sm sm:text-base text-gray-800 mb-0.5">Early Access</span>
                  <span className="text-xs text-gray-600">Be the first to try</span>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-gray-200/20 hover:border-gray-300/30 transition-colors shadow-sm">
                  <span className="block font-semibold text-sm sm:text-base text-gray-800 mb-0.5">AI-Powered</span>
                  <span className="text-xs text-gray-600">Smart analytics</span>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 border border-gray-200/20 hover:border-gray-300/30 transition-colors shadow-sm">
                  <span className="block font-semibold text-sm sm:text-base text-gray-800 mb-0.5">Priority Support</span>
